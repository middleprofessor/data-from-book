...
But, I think this is what we want. The top matrix of archived values are $\Delta C_q$ values, which decrease as expression levels increase. So to get the effects in the correct direction, we can multiply the $\Delta C_q$ values by -1.
