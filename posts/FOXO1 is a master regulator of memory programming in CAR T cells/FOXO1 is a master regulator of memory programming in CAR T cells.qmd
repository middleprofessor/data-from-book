...
categories: ['technical replicates', 'pseudoreplication', 'nested', 'CRDS']
description: "Technical replicates should not be analyzed as if they were randomly assigned to one of the experimental treatments. They weren't. The resulting p-value is junk."
format: 
  html: 
    toc: true 
    toc-location: right
