...
Count data in biology often have a distribution that approximates a sample from a Negative Binomial distribution. Two features of this distribution that violate assumptions of a linear/ANOVA model are
